    <div class="footer">
        <a href="https://code.google.com/p/fstat/">FStat</a> Version <?php echo $fstat_fstat_version; ?> from F-Soft by <a href="http://www.fabian-neffgen.de/">Fabian Neffgen</a><br>
