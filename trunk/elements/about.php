	<div class="border" style="text-align:left;">
		<div class="text">
			...
			&copy; F-Soft by <a href="http://fa-ne.tk/">Fabian Neffgen</a><br>
			<br>
			<?php echo FLANG_H_USEDBY; ?> <a href="http://user-agent-string.info/">UAString Api</a> (<?php echo FLANG_LAST_UPDATE." ".$uasdata_date; ?>),<br>
			<?php echo FLANG_H_IPBY; ?> <a href="http://ip-to-country.webhosting.info/">Webhosting.info</a><br>
			<?php echo FLANG_H_FLAGBY; ?> <a href="http://www.famfamfam.com/lab/icons/flags/">FamFamFam</a><br>
			<br>
			<?php echo FLANG_FEEDBACK; ?> <a href="mailto:fabian@fa-ne.tk?subject=FStat%20Version%20<?php echo rawurlencode($fstat_fstat_version);?>">fabian@fa-ne.tk</a>
		</div>
	</div>